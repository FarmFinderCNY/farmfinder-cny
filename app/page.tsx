  ...
  return (
    <main>
      ...
      <header id="top" className="slideshow-hero">
        ...
        <div className="slideshow-content shell"><p className="eyebrow">More than a map</p><h1>Fresh local food.<br /><em>Available today.</em></h1><p className="lede">Discover nearby farm stands, see what products are currently available, and connect directly with the people growing your food.</p><div className="keep-ny-callout"><span aria-hidden="true">♥</span><div><strong>Keep NY Farming</strong><p>Every trip to a local farm supports the people growing our food and helps keep New York farming strong.</p></div></div><div className="hero-actions"><a className="primary-button" href="#stands">Find fresh food <span>↓</span></a><Link className="farmer-hero-button" href="/farmer">Farmers: update what&apos;s fresh</Link><Link className="hero-list-link" href="/list-your-farm">Add or suggest a farm →</Link></div><div className="hero-message-row"><span>Find it local</span><i>•</i><span>Buy it local</span><i>•</i><span>Keep NY Farming</span></div></div>
      </header>
      ...
      <section className="shell" style={{ paddingTop: "2rem" }}><div className="notice" style={{ textAlign: "center", padding: "1.5rem" }}><p className="eyebrow">How FarmFinder works</p><h2 style={{ margin: "0.35rem 0 0.65rem" }}>Farmers share what&apos;s fresh. You find it nearby.</h2><p>Local farmers can keep their products up to date. Shoppers search for what they need, choose a nearby farm, and get directions to buy directly from local growers.</p><p style={{ marginTop: "0.85rem", fontWeight: 800 }}>Find it local. Buy it local. Keep NY Farming.</p></div></section>

      <section className="shell" style={{ paddingTop: "1rem" }}><div className="notice" style={{ textAlign: "center", padding: "1.5rem" }}><p className="eyebrow">📰 Upcoming Feature</p><h2 style={{ margin: "0.35rem 0 0.65rem" }}>FarmFinder CNY is coming to <em>In Good Health</em>.</h2><p>FarmFinder CNY is scheduled to be featured in an upcoming October 2026 edition of <em>In Good Health</em>.</p><p style={{ marginTop: "0.65rem" }}><strong>Coming October 2026</strong> · Check back after publication for a link to the feature.</p></div></section>
