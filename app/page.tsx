    ...
    <main>
      <nav className="nav shell" aria-label="Main navigation">
        ...
        <div className="nav-actions">
          ...
          <Link className="nav-link" href="/regions">Explore another region</Link>
      ...
      <header id="top" className="slideshow-hero">
        ...
        <div className="slideshow-content shell">
          <p className="eyebrow">More than a map</p><h1>Fresh local food.<br /><em>Available today.</em></h1>
      ...
      <section className="shell" style={{ paddingTop: "1.5rem" }}><div className="notice" style={{ textAlign: "center", padding: "1.25rem" }}><p className="eyebrow">🌎 FarmFinder is growing</p><h2 style={{ margin: ".35rem 0 .65rem" }}>Started in CNY. Find farms wherever you are.</h2><p>Central New York remains our home. You can now explore FarmFinder by state and help grow the map in your area.</p><p style={{ marginTop: ".9rem" }}><Link className="primary-button" href="/regions">Explore another region →</Link></p></div></section>
      ...
      <section className="shell" style={{ paddingTop: "2rem" }}><div className="notice" style={{ textAlign: "center", padding: "1.5rem" }}><p className="eyebrow">📰 FarmFinder CNY in the Media</p><h2 style={{ margin: "0.35rem 0 0.65rem" }}>Featured by Sentinel Media Company</h2><p><strong>Publisher of <em>The Daily Sentinel</em></strong></p><p style={{ marginTop: "0.65rem" }}>FarmFinder CNY was featured for helping Central New Yorkers discover and connect with local farms and farm stands.</p><p style={{ marginTop: "0.8rem" }}><a className="primary-button" href="https://www.romesentinel.com/news/farmfindercny/article_b28abbd6-55fc-44e2-bc49-d2f91e5153b4.html" target="_blank" rel="noopener noreferrer">Read the Daily Sentinel Feature →</a></p><div style={{ borderTop: "1px solid rgba(0,0,0,0.12)", marginTop: "1.5rem", paddingTop: "1.25rem" }}><p className="eyebrow">📰 Upcoming Feature</p><h2 style={{ margin: "0.35rem 0 0.65rem" }}><em>In Good Health</em></h2><p>FarmFinder CNY is scheduled to be featured in an upcoming edition of <em>In Good Health</em>.</p><p style={{ marginTop: "0.65rem" }}>Check back after publication for the feature.</p></div></div></section>
